	...
	<div class="main-page">
		...
		<div class="panel-body widget-shadow table-responsive">
			...
			<div class="form-title">
				...
				<h4>Creditos Automotrices :</h4>

				<?php if ($control_permisos["permisos"]->insert == 1): ?>

					<a href="<?= base_url()?>operaciones/denuncias/creditos_automotrices_add" class="btn btn-primary btn-flat btn-pri pull-right" style="margin-top: -25px;">
