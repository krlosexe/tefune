		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					<h3 class="title1">Registrar Denuncia</h3>
					<div class="row">
						<div class="col-md-12">
								...
								<div id="myTabContent" class="tab-content scrollbar1" tabindex="5001" style="overflow: hidden; outline: none;"> 
									<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab"> 
										...
										<div class="form-group col-md-12">
											 ...
											 <select name="type_denuncia" id="type_denuncia" class="form-control">
										...
										<div class="form-group col-md-6">
											 ...
											 <select name="provincias" id="provincias" class="form-control">
											 	...
											 	<?php foreach ($provincias as $value): ?>
											 		...
											 		<option value="<?= $value->id_provincia ?>"><?=$value->provincia?></option>
		...
		<script>
			...
			$("#btn-registro").on("click", function(){
				...
				$.ajax({
					...
					dataType: "json",
					data    : datos,
					url     : "<?= base_url()?>operaciones/denuncias/store",
			        ...
			        if(jqXHR.responseJSON.success == true){
			          ...
			          toastr.success(jqXHR.responseJSON.message);
				        ...
				        setTimeout(function(){
						     ...
						     location.href="<?= base_url()?>operaciones/denuncias/upload/"+id_denuncia;
