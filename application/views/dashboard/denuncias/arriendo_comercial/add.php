<!-- main content start-->
		<div id="page-wrapper">
			<div class="main-page">
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					<h3 class="title1">Registrar Denuncia por Arriendo Comercial</h3>
					<div class="row">
						<div class="col-md-12">
							<form class="forms">
								<div class="form-group col-md-6">
								 	<label for="id_tipo_comercial">Tipo comercial</label> 
									 <select name="id_tipo_comercial" id="id_tipo_comercial" class="form-control">
		...
		<script>
			$("#btn-save").on("click", function(){
				var datos = {
					"id_tipo_comercial"    : $("#id_tipo_comercial").val(),
				...
				$.ajax({
					...
					dataType: "json",
					data    : datos,
					url     : "<?= base_url()?>operaciones/denuncias/store_arriendo_comercial",
			        ...
			        if(jqXHR.responseJSON.success == true){
			          ...
			          toastr.success(jqXHR.responseJSON.message);
				        ...
				        setTimeout(function(){
						     ...
						     location.href="<?= base_url()?>operaciones/denuncias/upload/5/"+id_denuncia;
