		...
		<div id="page-wrapper">
			...
			<div class="main-page">
				...
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					...
					<h3 class="title1">Administrar Permisos</h3>
							...
							<form class="forms">
	                            ...
	                            <div class="form-group col-md-12">
	                                ...
	                                <label class="radio-inline">
	                                    ...
	                                    <input type="radio" id="update" name="update" value="1" checked="checked">Si

	                                </label>

	                                 <label class="radio-inline">

	                                    <input type="radio" id="update" name="update" value="0">No
	                            ...
	                            <div class="form-group col-md-12">
	                                ...
	                                <label class="radio-inline">
	                                    ...
	                                    <input type="radio" id="delete" name="delete" value="1" checked="checked">Si

	                                </label>

	                                 <label class="radio-inline">

	                                    <input type="radio" id="delete" name="delete" value="0">No
...
<script>
	...
	$("#btn-permisos").on("click", function(){
		...
		$.ajax({
			...
			url     : "<?= base_url()?>administrar/permisos/store",
